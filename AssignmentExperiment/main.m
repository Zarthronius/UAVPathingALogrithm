...
GADATA=[2  10  4; % Coldstream
        ...
        25  1 21]; % Keswick
GAEND = [26 11 14]; %
GADATAFULL = [GASTART; GADATA; GAEND]; %
...
fprintf("--------------------------------------------------------\n");
tic
experiment = GA(GAPOPULATIONSIZE,GAMUTATIONRATE,GADATA,GAEPOC,ELITE,LOGGING,GASTART,GAEND); %
build = toc;
...
fprintf("====================================================\n");
%experiment.bestInd.gene = [experiment.bestInd.gene]%
